...
class Save extends CustomRedirectController
{
    ...
    /**
     * @var \MageWorx\SeoRedirects\Controller\Adminhtml\CustomRedirectHelper
     */
    protected $customRedirectHelper;

    /**
     * @var RedirectTypeRequestKey
     */
    protected $redirectTypeRequestKeyOptions;

    /**
     * @var RedirectTypeTargetKey
     */
...
//                        $this->urlFinder->findAllByData()
    ...
    /**
     * Check is redirect request data similar to target data
     *
     * @param array $data
     * @return bool
     */
    protected function isRecursiveRedirect(array $data): bool
    {
        return $data[CustomRedirectInterface::REQUEST_ENTITY_TYPE] === $data[CustomRedirectInterface::TARGET_ENTITY_TYPE]
                && (isset($data['request_entity_identifier'])
