define([
    ...
    return BaseButton.extend({
        ...
        getFormData: function () {
            let productFormSource = registry.get('product_listing.product_listing_data_source'),
                formData,
                formKey = $(this.formKeySelector).val();

            if (productFormSource) {
                formData = Object.assign({}, productFormSource.product_listing.mageworx_seo);
            } else {
                formData = {};
            }
        ...
        getMassActionSelections: function () {
            let massAction = registry.get("product_listing.product_listing.listing_top.listing_massaction");
            if (massAction === null) {
                return null;
            }
