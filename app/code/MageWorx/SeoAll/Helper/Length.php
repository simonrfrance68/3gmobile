...
{
    public const XML_PATH_LENGTH_META_TITLE_MAX = 'mageworx_seo/all/length/meta_title_max';
    public const XML_PATH_LENGTH_META_DESCRIPTION_MAX = 'mageworx_seo/all/length/meta_description_max';
    public const XML_PATH_LENGTH_META_KEYWORDS_MAX    = 'mageworx_seo/all/length/meta_keywords_max';
    public const XML_PATH_LENGTH_H1_MAX            = 'mageworx_seo/all/length/h1_max';
    public const XML_PATH_LENGTH_URL_PATH_MAX = 'mageworx_seo/all/length/url_max';
