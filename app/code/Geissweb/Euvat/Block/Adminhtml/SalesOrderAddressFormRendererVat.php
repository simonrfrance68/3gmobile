...
class SalesOrderAddressFormRendererVat extends \Magento\Backend\Block\Widget\Form\Renderer\Fieldset\Element
{
     ...
     * @param \Geissweb\Euvat\Helper\Compat\JsonFactory $jsonEncoder
     * @param array                                     $data
     */
    public function __construct(
        \Geissweb\Euvat\Helper\Configuration $configHelper,
        \Magento\Backend\Block\Template\Context $context,
        \Geissweb\Euvat\Helper\Compat\JsonFactory $jsonEncoder,
        array $data = []
    ) {
        $this->_jsonEncoder = $jsonEncoder->create();
        if ($this->_jsonEncoder instanceof \Magento\Framework\Json\EncoderInterface) {
