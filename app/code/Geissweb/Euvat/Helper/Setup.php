...
class Setup
{
    ...
    public function getStoreConfigValues($baseCc, $key, $vatId, $installType, $withRules = false)
    {
        $config = [
            ...
            'general/store_information/merchant_vat_number' => $this->functionsHelper->formatVatNumber($vatId),
     ...
     * @return array
     */
    public function getTaxRatesInsertArray($baseCc, $withDigital = false, $withReduced = false, $reducedRate = null, $withNonEu = false)
    {
